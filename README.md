...
Webpage built with .NET Core using Entity Framework migrations, SQL Server, and Identity Authentication.  Two-day project practicing Identity Authentication for Week 2 of Epicodus .NET curriculum.
